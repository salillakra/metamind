...
const Hamburgur = ({
  ...
  return (
    <div
      {...props}
      className={`fixed inset-0 bg-[rgba(0,0,0,0.8)] z-50 transition-opacity duration-500 ease-in-out ${
        isOpen ? "opacity-100" : "opacity-0 pointer-events-none"
      } ${className}`}
      onClick={() => setOpen(false)}
    >
      <div
        className={`absolute left-0 top-0 h-full w-[75%] md:w-[60%] bg-slate-950 shadow-2xl transition-transform duration-500 ease-in-out ${
        ...
        <div className="pt-4 border-t border-gray-500 font-thin text-md">
          ...
          >
            <Link
              ...
              href="secure/dashboard/my-Posts"
            >
              <StickyNote />
              My Posts
            </Link>
